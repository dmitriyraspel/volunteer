...
function volunteer_scripts() {
	wp_enqueue_style( 'volunteer-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'volunteer-style', 'rtl', 'replace' );

	wp_enqueue_script( 'volunteer-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
